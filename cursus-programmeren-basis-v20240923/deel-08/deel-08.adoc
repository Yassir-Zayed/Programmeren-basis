...
In alle voorbeelden tot dusver, werd in de array-initializer aan de hand van een `int` literal bepaald hoeveel slots in de array werden voorzien.  Bijvoorbeeld: `new string[*6*]` zal een array met ruimte voor __6__ elementen aanmaken.
...
Op die manier wordt dus __pas tijdens de uitvoering__ bepaalt hoe groot de array moet zijn. Vandaar dat we het een __dynamische__ grootte noemen.
...
Indien we het voorbeeld uitproberen en de gebruiker __3__ namen wil ingeven krijgen we de volgende uitvoering...
...
De array zal beschikken over __3__ slots, en elk element werd netjes opgevuld met een `string`.
****
