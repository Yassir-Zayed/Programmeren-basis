...
https://www.academicsoftware.eu[Academic Software]

Log daar aan -als het nog nodig is- met je @student.hogent.be e-mailadres.

Zoek op __Visual Studio__ en selecteer __Visual Studio Enterprise 2022__.  

image::Visual Studio Enterprise 2022 - Downloaden.png[Visual Studio Enterprise 2022 - Downloaden]

Haal de __Product key__ (licenties of registratie sleutel) op en bewaar ze voor straks.
Je kan ook later op __Academic Software__ platform herinloggen, om hier opnieuw deze sleutel terug te vinden.
